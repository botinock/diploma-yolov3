...
class Model(nn.Module):
    def __init__(self, cfg='yolov3-rotate.yaml', ch=3, nc=None):  # model, input channels, number of classes
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    no = na * (nc + 6)  # number of outputs = anchors * (classes + 5) + angle
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov3-rotate.yaml', help='model.yaml')
